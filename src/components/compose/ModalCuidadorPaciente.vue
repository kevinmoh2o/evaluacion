<template>
<div class="modal fade" id="modalCuidadorPaciente" tabindex="-1" aria-labelledby="modalCuidadorPaciente" aria-hidden="true">
              ...
              <div class="modal-body">
                ...
                <form @submit="submitForm" class="needs-validation" novalidate>
                      <div class="cuidador-box">
                        ...
                        <div class="caja">
                            <i class="fas fa-id-card"></i>
                            <input type="number" class="form-control" id="validationCustom01" placeholder="Documento de Identidad" min="0" max="1000000000000000" required>
                        </div>
                        ...
                        <div class="caja">
                            ...
                            <input type="number" class="form-control" id="validationCustom01" placeholder="Edad" required min="18" max="100">
                        </div>
                        ...
                        <div class="caja">
                            ...
                            <input type="number" class="form-control" id="validationCustom01" placeholder="Celular" min="0" required>
                        </div>
                      ...
                      <div class="cuidador-box">
                          ...
                          <div class="caja">
                              ...
                              <input type="email" class="form-control" id="validationCustom01" placeholder="Correo electrónico" required>
                          </div>
