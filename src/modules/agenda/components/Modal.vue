                      ...
                      <div class="row px-2 m-0">
                          <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6 row m-0 p-0">
                              ...
                              <div class="col-11 m-0 p-0">
                                  <label for="recipient-name" class="col-12 fw-semibold px-1 align-left">Licenciado a Cargo:</label>
                                  <label for="recipient-name" class="col-12 px-1 align-left">Kevin Basilio Montañez Huamán</label>
                              </div>
                          </div>
                          ...
                          <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6 row m-0 p-0">
                              ...
                              <div class="col-11 m-0 p-0">
                                  <label for="recipient-name" class="col-12 fw-semibold px-1 align-left">Fecha de cita:</label>
