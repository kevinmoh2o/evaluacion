  ...
  <div class="main-menu">
    ...
    <div class="barra-lateral"
      ...
      <nav class="navegacion">
        <ul>
          <li>
            <a id="main-menu" :class="{ 'seleccion': boolFlags['main-menu'] }"
              @click.prevent="showContent('main-menu')">
          ...
          <li>
            <a id="agenda" :class="{ 'seleccion': boolFlags['agenda'] }" @click.prevent="showContent('agenda')">
          ...
          <li>
            <a id="tema-consejeria" :class="{ 'seleccion': boolFlags['tema-consejeria'] }"
              @click.prevent="showContent('tema-consejeria')">
          ...
          <li>
            <a id="registro-consejeria" :class="{ 'seleccion': boolFlags['registro-consejeria'] }"
              @click.prevent="showContent('registro-consejeria')">
              <ion-icon name="clipboard-outline"></ion-icon>
              Registro de Consejeria
            </a>
          </li>

          <li>
            <a id="registrar" :class="{ 'seleccion': boolFlags['registrar'] }"
              @click.prevent="showContent('registrar')">
          ...
          <li>
            <a id="equipos" :class="{ 'seleccion': boolFlags['equipos'] }" @click.prevent="showContent('equipos')">
              <ion-icon name="hammer-outline"></ion-icon>Equipos de Trabajo
            </a>
          </li>

          <li>
            <a id="soporte" :class="{ 'seleccion': boolFlags['soporte'] }" @click.prevent="showContent('soporte')">
          ...
          <li>
            <a id="satisfaccion" :class="{ 'seleccion': boolFlags['satisfaccion'] }"
              @click.prevent="showContent('satisfaccion')">
    ...
    <main :class="{ 'min-main': !isMaxBarraLateral }">
      <transition name="fade" mode="out-in">
        ...
        <div v-else-if="selectedContent === 'soporte'" class="menu-contenido">
...
<script>
  ...
  import SoporteTecnico from '@/layouts/SoporteTecnico.vue';
  ...
  export default {
    ...
    methods: {
      ...
      ...mapGetters('programacionModule', ['getUsuarioPersonaList']),
      toggleSidebar() {
      ...
      showContent(content) {
        ...
        for (const key in this.boolFlags) {
          if (Object.hasOwnProperty.call(this.boolFlags, key)) {
            this.boolFlags[key] = key === content;
          }
        }
      },
