...
import EstrellaQuest from '@/components/atomic/EstrellaQuest.vue';
export default {
    ...
    methods: {
        ...
        readSelectedIndexEmit(value) {
            console.log("readSelectedIndexEmit value: ", value)
        },
        presionado(value) {
            console.log("presionado value: ", value)
        },
    }
}
</script>
